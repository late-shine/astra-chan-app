...
export const KANJI_DATA: KanjiItem[] = [
  ...
  { kanji: "校", meaning: "School", onyomi: "コウ", onyomiRomaji: "kou", kunyomi: "かせ", kunyomiRomaji: "kase", mnemonic: "A wooded tower structure where students collect ideas.", strokeCount: 10, examples: [{ japanese: "学校 (がっこう)", romaji: "gakkou", english: "School" }, { japanese: "校長 (こうちょう)", romaji: "kouchou", english: "Principal" }, { japanese: "高校 (こうこう)", romaji: "koukou", english: "High school" }] },

  // People / Body Parts [12]
  { kanji: "人", meaning: "Person", onyomi: "ジン、ニン", onyomiRomaji: "jin, nin", kunyomi: "ひと", kunyomiRomaji: "hito", mnemonic: "A sideways profile of a bipedal figure standing.", strokeCount: 2, examples: [{ japanese: "あの人 (あのひと)", romaji: "ano hito", english: "That person" }, { japanese: "日本人 (にほんじん)", romaji: "nihonjin", english: "Japanese person" }, { japanese: "三人 (さんにん)", romaji: "sannin", english: "Three people" }] },
  { kanji: "子", meaning: "Child", onyomi: "シ、ス", onyomiRomaji: "shi, su", kunyomi: "こ", kunyomiRomaji: "ko", mnemonic: "A swaddled infant stretching its tiny arms wide.", strokeCount: 3, examples: [{ japanese: "子供 (こども)", romaji: "kodomo", english: "Child" }, { japanese: "様子 (ようす)", romaji: "yousu", english: "Situation / Appearance" }, { japanese: "女の子 (おんなのこ)", romaji: "onnanoko", english: "Girl" }] },
  ...
  { kanji: "手", meaning: "Hand", onyomi: "シュ", onyomiRomaji: "shu", kunyomi: "て", kunyomiRomaji: "te", mnemonic: "A outstretched palm displaying its clean fingerprint lines.", strokeCount: 4, examples: [{ japanese: "手紙 (てがみ)", romaji: "tegami", english: "Letter" }, { japanese: "歌手 (かしゅ)", romaji: "kashu", english: "Singer" }, { japanese: "上手 (じょうず)", romaji: "jouzu", english: "Skilled" }] },
  ...
  { kanji: "先", meaning: "Previous / Ahead", onyomi: "セン", onyomiRomaji: "sen", kunyomi: "さき", kunyomiRomaji: "saki", mnemonic: "A set of walking toes moving out ahead of anyone else.", strokeCount: 6, examples: [{ japanese: "先生 (せんせい)", romaji: "sensei", english: "Teacher" }, { japanese: "先月 (せんげつ)", romaji: "sengetsu", english: "Last month" }, { japanese: "先週 (せんしゅう)", romaji: "senshuu", english: "Last week" }] },
  { kanji: "生", meaning: "Life / Born", onyomi: "セイ", onyomiRomaji: "sei", kunyomi: "う-まれる、なま", kunyomiRomaji: "u-mareru, nama", mnemonic: "A fresh green plant sprout breaking through solid earth.", strokeCount: 5, examples: [{ japanese: "生きる (いきる)", romaji: "ikiru", english: "To live" }, { japanese: "学生 (がくせい)", romaji: "gakusei", english: "Student" }, { japanese: "先生 (せんせい)", romaji: "sensei", english: "Teacher" }] },
  ...
  { kanji: "大", meaning: "Large / Big", onyomi: "ダイ", onyomiRomaji: "dai", kunyomi: "おお-きい", kunyomiRomaji: "oo-kii", mnemonic: "A person stretching their limbs as wide as physically possible.", strokeCount: 3, examples: [{ japanese: "大きい (おおきい)", romaji: "ookii", english: "Big" }, { japanese: "大学 (だいがく)", romaji: "daigaku", english: "University" }, { japanese: "大人 (おとな)", romaji: "otona", english: "Adult" }] },
  { kanji: "小", meaning: "Small", onyomi: "ショウ", onyomiRomaji: "shou", kunyomi: "ちい-さい", kunyomiRomaji: "chii-sai", mnemonic: "An item divided into three tiny fractions with a hook.", strokeCount: 3, examples: [{ japanese: "小さい (ちいさい)", romaji: "chiisai", english: "Small" }, { japanese: "小学校 (しょうがっこう)", romaji: "shougakkou", english: "Elementary School" }, { japanese: "小説 (しょうせつ)", romaji: "shousetsu", english: "Novel" }] },
  { kanji: "高", meaning: "High / Tall / Expensive", onyomi: "コウ", onyomiRomaji: "kou", kunyomi: "たか-い", kunyomiRomaji: "taka-i", mnemonic: "The silhouette of a high, multistoried watchtower building.", strokeCount: 10, examples: [{ japanese: "高い (たかい)", romaji: "takai", english: "High / Tall / Expensive" }, { japanese: "高校 (こうこう)", romaji: "koukou", english: "High school" }, { japanese: "最高 (さいこう)", romaji: "saikou", english: "Awesome / Highest" }] },
  ...
  { kanji: "分", meaning: "Minute / Understand", onyomi: "ブン、フン", onyomiRomaji: "bun, fun", kunyomi: "わ-かる", kunyomiRomaji: "wa-karu", mnemonic: "Using a sharp blade or knife to divide particles in fractions.", strokeCount: 4, examples: [{ japanese: "分かる (わかる)", romaji: "wakaru", english: "To understand" }, { japanese: "五分 (ごふん)", romaji: "gofun", english: "Five minutes" }, { japanese: "自分 (じぶん)", romaji: "jibun", english: "Oneself" }] },
  { kanji: "国", meaning: "Country", onyomi: "コク", onyomiRomaji: "koku", kunyomi: "くに", kunyomiRomaji: "kuni", mnemonic: "A sovereign jade treasure protected within wide borders.", strokeCount: 8, examples: [{ japanese: "外国 (がいこく)", romaji: "gaikoku", english: "Foreign country" }, { japanese: "中国 (ちゅうごく)", romaji: "chuugoku", english: "China" }, { japanese: "英国 (えいこく)", romaji: "eikoku", english: "United Kingdom" }] },
  ...
  { kanji: "本", meaning: "Book / Origin", onyomi: "ホン", onyomiRomaji: "hon", kunyomi: "もと", kunyomiRomaji: "moto", mnemonic: "A tree character with an extra horizontal root marking its base.", strokeCount: 5, examples: [{ japanese: "日本 (にほん)", romaji: "nihon", english: "Japan" }, { japanese: "本棚 (ほんだな)", romaji: "hondana", english: "Bookshelf" }, { japanese: "山本 (やまもと)", romaji: "yamamoto", english: "Yamamoto (Surname)" }] },
  ...
  { kanji: "花", meaning: "Flower", onyomi: "カ", onyomiRomaji: "ka", kunyomi: "はな", kunyomiRomaji: "hana", mnemonic: "Grass transforming dynamically into colorful beautiful petals.", strokeCount: 7, examples: [{ japanese: "花瓶 (かびん)", romaji: "kabin", english: "Flower Vase" }, { japanese: "花見 (はなみ)", romaji: "hanami", english: "Flower Viewing" }, { japanese: "花火 (はなび)", romaji: "hanabi", english: "Fireworks" }] },
  ...
  { kanji: "学", meaning: "Study / Learn", onyomi: "ガク", onyomiRomaji: "gaku", kunyomi: "まな-ぶ", kunyomiRomaji: "manabu", mnemonic: "A nested kid under building rafters getting bright insights.", strokeCount: 8, examples: [{ japanese: "学校 (がっこう)", romaji: "gakkou", english: "School" }, { japanese: "学生 (がくせい)", romaji: "gakusei", english: "Student" }, { japanese: "大学 (だいがく)", romaji: "daigaku", english: "University" }] },
  ...
  // More N5 Essentials — Time & Question Words [7]
  { kanji: "半", meaning: "Half", onyomi: "ハン", onyomiRomaji: "han", kunyomi: "なか-ば", kunyomiRomaji: "naka-ba", mnemonic: "A single blade cutting a bundle clean down the middle.", strokeCount: 5, examples: [{ japanese: "半分 (はんぶん)", romaji: "hanbun", english: "Half" }, { japanese: "三時半 (さんじはん)", romaji: "sanjihan", english: "3:30" }] },
  { kanji: "今", meaning: "Now", onyomi: "コン", onyomiRomaji: "kon", kunyomi: "いま", kunyomiRomaji: "ima", mnemonic: "A figure ducking under a roof to seize this very moment.", strokeCount: 4, examples: [{ japanese: "今日 (きょう)", romaji: "kyou", english: "Today" }, { japanese: "今週 (こんしゅう)", romaji: "konshuu", english: "This week" }] },
  { kanji: "午", meaning: "Noon", onyomi: "ゴ", onyomiRomaji: "go", kunyomi: "うま", kunyomiRomaji: "uma", mnemonic: "A tall pole casting no shadow at the sun's highest point.", strokeCount: 4, examples: [{ japanese: "午前 (ごぜん)", romaji: "gozen", english: "A.M." }, { japanese: "午後 (ごご)", romaji: "gogo", english: "P.M." }] },
  { kanji: "帰", meaning: "To Return", onyomi: "キ", onyomiRomaji: "ki", kunyomi: "かえ-る", kunyomiRomaji: "kae-ru", mnemonic: "A tired traveler sweeping their way back to the home gate.", strokeCount: 10, examples: [{ japanese: "帰る (かえる)", romaji: "kaeru", english: "To go home" }, { japanese: "帰国 (きこく)", romaji: "kikoku", english: "Returning to one's country" }] },
  { kanji: "町", meaning: "Town", onyomi: "チョウ", onyomiRomaji: "chou", kunyomi: "まち", kunyomiRomaji: "machi", mnemonic: "A rice field marked off by a well-defined town boundary.", strokeCount: 7, examples: [{ japanese: "町 (まち)", romaji: "machi", english: "Town" }, { japanese: "町長 (ちょうちょう)", romaji: "chouchou", english: "Town mayor" }] },
  { kanji: "何", meaning: "What", onyomi: "カ", onyomiRomaji: "ka", kunyomi: "なに、なん", kunyomiRomaji: "nani, nan", mnemonic: "A curious figure hoisting a mystery load, wondering what's inside.", strokeCount: 7, examples: [{ japanese: "何 (なに)", romaji: "nani", english: "What" }, { japanese: "何時 (なんじ)", romaji: "nanji", english: "What time" }] },
  { kanji: "黒", meaning: "Black", onyomi: "コク", onyomiRomaji: "koku", kunyomi: "くろ-い", kunyomiRomaji: "kuro-i", mnemonic: "Soot from a low fire staining the ground a deep, sooty black.", strokeCount: 11, examples: [{ japanese: "黒い (くろい)", romaji: "kuroi", english: "Black" }, { japanese: "黒板 (こくばん)", romaji: "kokuban", english: "Blackboard" }] },

  // More N5 Essentials — People, Self & Feelings [7]
  { kanji: "私", meaning: "I / Private", onyomi: "シ", onyomiRomaji: "shi", kunyomi: "わたし、わたくし", kunyomiRomaji: "watashi, watakushi", mnemonic: "A hand drawing a private line around one's own share of grain.", strokeCount: 7, examples: [{ japanese: "私 (わたし)", romaji: "watashi", english: "I / me" }, { japanese: "私立 (しりつ)", romaji: "shiritsu", english: "Private (school)" }] },
  { kanji: "自", meaning: "Self", onyomi: "ジ、シ", onyomiRomaji: "ji, shi", kunyomi: "みずか-ら", kunyomiRomaji: "mizuka-ra", mnemonic: "A nose — the spot everyone instinctively points to when they mean themselves.", strokeCount: 6, examples: [{ japanese: "自分 (じぶん)", romaji: "jibun", english: "Oneself" }, { japanese: "自転車 (じてんしゃ)", romaji: "jitensha", english: "Bicycle" }] },
  { kanji: "方", meaning: "Direction / Way", onyomi: "ホウ", onyomiRomaji: "hou", kunyomi: "かた", kunyomiRomaji: "kata", mnemonic: "A signpost's arm pointing travelers the correct way to go.", strokeCount: 4, examples: [{ japanese: "方法 (ほうほう)", romaji: "houhou", english: "Method" }, { japanese: "あの方 (あのかた)", romaji: "ano kata", english: "That person (polite)" }] },
  { kanji: "体", meaning: "Body", onyomi: "タイ", onyomiRomaji: "tai", kunyomi: "からだ", kunyomiRomaji: "karada", mnemonic: "A person leaning their whole weight against their own solid frame.", strokeCount: 7, examples: [{ japanese: "体 (からだ)", romaji: "karada", english: "Body" }, { japanese: "体育 (たいいく)", romaji: "taiiku", english: "Physical education" }] },
  { kanji: "心", meaning: "Heart / Mind", onyomi: "シン", onyomiRomaji: "shin", kunyomi: "こころ", kunyomiRomaji: "kokoro", mnemonic: "The simple curved outline of a beating heart.", strokeCount: 4, examples: [{ japanese: "心配 (しんぱい)", romaji: "shinpai", english: "Worry" }, { japanese: "安心 (あんしん)", romaji: "anshin", english: "Relief / peace of mind" }] },
  { kanji: "元", meaning: "Origin / Former", onyomi: "ゲン、ガン", onyomiRomaji: "gen, gan", kunyomi: "もと", kunyomiRomaji: "moto", mnemonic: "Two legs standing firmly at the very root where it all began.", strokeCount: 4, examples: [{ japanese: "元気 (げんき)", romaji: "genki", english: "Healthy / energetic" }, { japanese: "地元 (じもと)", romaji: "jimoto", english: "Hometown" }] },
  { kanji: "好", meaning: "To Like / Fond Of", onyomi: "コウ", onyomiRomaji: "kou", kunyomi: "す-き、この-む", kunyomiRomaji: "su-ki, kono-mu", mnemonic: "A mother holding her child — the picture of pure fondness.", strokeCount: 6, examples: [{ japanese: "好き (すき)", romaji: "suki", english: "Like / fond of" }, { japanese: "大好き (だいすき)", romaji: "daisuki", english: "Love / really like" }] },

  // More N5 Essentials — Common Verbs [10]
  { kanji: "転", meaning: "To Roll / Turn", onyomi: "テン", onyomiRomaji: "ten", kunyomi: "ころ-がる", kunyomiRomaji: "koro-garu", mnemonic: "A cart wheel tumbling and turning down a rolling slope.", strokeCount: 11, examples: [{ japanese: "自転車 (じてんしゃ)", romaji: "jitensha", english: "Bicycle" }, { japanese: "転校 (てんこう)", romaji: "tenkou", english: "Changing schools" }] },
  { kanji: "使", meaning: "To Use", onyomi: "シ", onyomiRomaji: "shi", kunyomi: "つか-う", kunyomiRomaji: "tsuka-u", mnemonic: "An official messenger sent out to put orders to use.", strokeCount: 8, examples: [{ japanese: "使う (つかう)", romaji: "tsukau", english: "To use" }, { japanese: "大使館 (たいしかん)", romaji: "taishikan", english: "Embassy" }] },
  { kanji: "待", meaning: "To Wait", onyomi: "タイ", onyomiRomaji: "tai", kunyomi: "ま-つ", kunyomiRomaji: "ma-tsu", mnemonic: "Standing patiently outside the temple gate until the moment comes.", strokeCount: 9, examples: [{ japanese: "待つ (まつ)", romaji: "matsu", english: "To wait" }, { japanese: "期待 (きたい)", romaji: "kitai", english: "Expectation" }] },
  { kanji: "持", meaning: "To Hold / Have", onyomi: "ジ", onyomiRomaji: "ji", kunyomi: "も-つ", kunyomiRomaji: "mo-tsu", mnemonic: "A hand gripping something firmly, keeping it close by.", strokeCount: 9, examples: [{ japanese: "持つ (もつ)", romaji: "motsu", english: "To hold / carry" }, { japanese: "気持ち (きもち)", romaji: "kimochi", english: "Feeling" }] },
  { kanji: "知", meaning: "To Know", onyomi: "チ", onyomiRomaji: "chi", kunyomi: "し-る", kunyomiRomaji: "shi-ru", mnemonic: "An arrow of insight landing squarely on the target of understanding.", strokeCount: 8, examples: [{ japanese: "知る (しる)", romaji: "shiru", english: "To know" }, { japanese: "知らせる (しらせる)", romaji: "shiraseru", english: "To inform" }] },
  { kanji: "思", meaning: "To Think", onyomi: "シ", onyomiRomaji: "shi", kunyomi: "おも-う", kunyomiRomaji: "omo-u", mnemonic: "Quiet thoughts stirring within the field of one's own heart.", strokeCount: 9, examples: [{ japanese: "思う (おもう)", romaji: "omou", english: "To think" }, { japanese: "思い出 (おもいで)", romaji: "omoide", english: "Memory" }] },
  { kanji: "歩", meaning: "To Walk", onyomi: "ホ", onyomiRomaji: "ho", kunyomi: "ある-く", kunyomiRomaji: "aru-ku", mnemonic: "Two small steps stacked one after the other, moving ahead.", strokeCount: 8, examples: [{ japanese: "歩く (あるく)", romaji: "aruku", english: "To walk" }, { japanese: "散歩 (さんぽ)", romaji: "sanpo", english: "A walk / stroll" }] },
  { kanji: "走", meaning: "To Run", onyomi: "ソウ", onyomiRomaji: "sou", kunyomi: "はし-る", kunyomiRomaji: "hashi-ru", mnemonic: "Legs pumping fast beneath a figure leaning forward at speed.", strokeCount: 7, examples: [{ japanese: "走る (はしる)", romaji: "hashiru", english: "To run" }, { japanese: "競走 (きょうそう)", romaji: "kyousou", english: "A race" }] },
  { kanji: "乗", meaning: "To Ride", onyomi: "ジョウ", onyomiRomaji: "jou", kunyomi: "の-る", kunyomiRomaji: "no-ru", mnemonic: "A figure climbing up onto a branch to catch a lift.", strokeCount: 9, examples: [{ japanese: "乗る (のる)", romaji: "noru", english: "To ride" }, { japanese: "乗り物 (のりもの)", romaji: "norimono", english: "Vehicle" }] },
  { kanji: "働", meaning: "To Work", onyomi: "ドウ", onyomiRomaji: "dou", kunyomi: "はたら-く", kunyomiRomaji: "hatara-ku", mnemonic: "A person moving briskly between tasks, always in motion.", strokeCount: 13, examples: [{ japanese: "働く (はたらく)", romaji: "hataraku", english: "To work" }, { japanese: "共働き (ともばたらき)", romaji: "tomobataraki", english: "Dual-income (household)" }] },

  // More N5 Essentials — Colors & Animals [7]
  { kanji: "青", meaning: "Blue", onyomi: "セイ", onyomiRomaji: "sei", kunyomi: "あお-い", kunyomiRomaji: "ao-i", mnemonic: "A fresh green sprout growing beside a clear, blue well.", strokeCount: 8, examples: [{ japanese: "青い (あおい)", romaji: "aoi", english: "Blue" }, { japanese: "青年 (せいねん)", romaji: "seinen", english: "Young man" }] },
  { kanji: "茶", meaning: "Tea / Brown", onyomi: "チャ、サ", onyomiRomaji: "cha, sa", kunyomi: "–", kunyomiRomaji: "–", mnemonic: "Tea leaves steeping slowly over a warm wooden fire.", strokeCount: 9, examples: [{ japanese: "お茶 (おちゃ)", romaji: "ocha", english: "Tea" }, { japanese: "茶色 (ちゃいろ)", romaji: "chairo", english: "Brown" }] },
  { kanji: "色", meaning: "Color", onyomi: "ショク、シキ", onyomiRomaji: "shoku, shiki", kunyomi: "いろ", kunyomiRomaji: "iro", mnemonic: "A kneeling figure admiring the many shades laid out before them.", strokeCount: 6, examples: [{ japanese: "色 (いろ)", romaji: "iro", english: "Color" }, { japanese: "景色 (けしき)", romaji: "keshiki", english: "Scenery" }] },
  { kanji: "犬", meaning: "Dog", onyomi: "ケン", onyomiRomaji: "ken", kunyomi: "いぬ", kunyomiRomaji: "inu", mnemonic: "A loyal companion, with one extra dot marking its wagging tail.", strokeCount: 4, examples: [{ japanese: "犬 (いぬ)", romaji: "inu", english: "Dog" }, { japanese: "子犬 (こいぬ)", romaji: "koinu", english: "Puppy" }] },
  { kanji: "猫", meaning: "Cat", onyomi: "ビョウ", onyomiRomaji: "byou", kunyomi: "ねこ", kunyomiRomaji: "neko", mnemonic: "A whiskered creature curled up napping beside the rice fields.", strokeCount: 11, examples: [{ japanese: "猫 (ねこ)", romaji: "neko", english: "Cat" }, { japanese: "子猫 (こねこ)", romaji: "koneko", english: "Kitten" }] },
  { kanji: "魚", meaning: "Fish", onyomi: "ギョ", onyomiRomaji: "gyo", kunyomi: "さかな、うお", kunyomiRomaji: "sakana, uo", mnemonic: "A simple sketch of a fish's head, body, and tail fin.", strokeCount: 11, examples: [{ japanese: "魚 (さかな)", romaji: "sakana", english: "Fish" }, { japanese: "金魚 (きんぎょ)", romaji: "kingyo", english: "Goldfish" }] },
  { kanji: "肉", meaning: "Meat", onyomi: "ニク", onyomiRomaji: "niku", kunyomi: "–", kunyomiRomaji: "–", mnemonic: "A cut of meat still wrapped in its own outline, ready to cook.", strokeCount: 6, examples: [{ japanese: "肉 (にく)", romaji: "niku", english: "Meat" }, { japanese: "牛肉 (ぎゅうにく)", romaji: "gyuuniku", english: "Beef" }] },

  // More N5 Essentials — Food, Home, Family & Extras [9]
  { kanji: "米", meaning: "Rice", onyomi: "ベイ、マイ", onyomiRomaji: "bei, mai", kunyomi: "こめ", kunyomiRomaji: "kome", mnemonic: "Grains of rice scattered evenly around a central stalk.", strokeCount: 6, examples: [{ japanese: "米 (こめ)", romaji: "kome", english: "Rice (uncooked)" }, { japanese: "白米 (はくまい)", romaji: "hakumai", english: "White rice" }] },
  { kanji: "家", meaning: "House / Family", onyomi: "カ、ケ", onyomiRomaji: "ka, ke", kunyomi: "いえ、うち", kunyomiRomaji: "ie, uchi", mnemonic: "A pig sheltered safely beneath a sturdy family roof.", strokeCount: 10, examples: [{ japanese: "家 (いえ)", romaji: "ie", english: "House" }, { japanese: "家族 (かぞく)", romaji: "kazoku", english: "Family" }] },
  { kanji: "族", meaning: "Family / Clan", onyomi: "ゾク", onyomiRomaji: "zoku", kunyomi: "–", kunyomiRomaji: "–", mnemonic: "A banner and an arrow rallying an entire clan together.", strokeCount: 11, examples: [{ japanese: "家族 (かぞく)", romaji: "kazoku", english: "Family" }] },
  { kanji: "兄", meaning: "Older Brother", onyomi: "ケイ、キョウ", onyomiRomaji: "kei, kyou", kunyomi: "あに", kunyomiRomaji: "ani", mnemonic: "A tall mouth speaking with the quiet authority of the eldest.", strokeCount: 5, examples: [{ japanese: "兄 (あに)", romaji: "ani", english: "Older brother" }, { japanese: "お兄さん (おにいさん)", romaji: "oniisan", english: "Older brother (polite)" }] },
  { kanji: "姉", meaning: "Older Sister", onyomi: "シ", onyomiRomaji: "shi", kunyomi: "あね", kunyomiRomaji: "ane", mnemonic: "A woman carrying herself with the poise of the eldest daughter.", strokeCount: 8, examples: [{ japanese: "姉 (あね)", romaji: "ane", english: "Older sister" }, { japanese: "お姉さん (おねえさん)", romaji: "oneesan", english: "Older sister (polite)" }] },
  { kanji: "弟", meaning: "Younger Brother", onyomi: "テイ、ダイ", onyomiRomaji: "tei, dai", kunyomi: "おとうと", kunyomiRomaji: "otouto", mnemonic: "A bow wound in cord, marking the junior sibling's place in line.", strokeCount: 7, examples: [{ japanese: "弟 (おとうと)", romaji: "otouto", english: "Younger brother" }, { japanese: "弟子 (でし)", romaji: "deshi", english: "Disciple / apprentice" }] },
  { kanji: "妹", meaning: "Younger Sister", onyomi: "マイ", onyomiRomaji: "mai", kunyomi: "いもうと", kunyomiRomaji: "imouto", mnemonic: "A woman still young, not yet grown to her full height.", strokeCount: 8, examples: [{ japanese: "妹 (いもうと)", romaji: "imouto", english: "Younger sister" }, { japanese: "姉妹 (しまい)", romaji: "shimai", english: "Sisters" }] },
  { kanji: "曜", meaning: "Day Of The Week", onyomi: "ヨウ", onyomiRomaji: "you", kunyomi: "–", kunyomiRomaji: "–", mnemonic: "The sun beside a bright-feathered bird, marking each day's turn.", strokeCount: 18, examples: [{ japanese: "日曜日 (にちようび)", romaji: "nichiyoubi", english: "Sunday" }, { japanese: "何曜日 (なんようび)", romaji: "nan'youbi", english: "What day of the week" }] },
...
// ─────────────────────────────────────────────────────────────────────────────
  ...
  // ── VOCABULARY_DATA  Part 3  (+100 entries, 694 total) ────────────────────

  // ── New Actions (30) ──────────────────────────────────────────────────────
  { word: "旅行する",     hiragana: "りょこうする",   romaji: "ryokousuru",   english: "To travel",                        category: "actions" },
  { word: "練習する",     hiragana: "れんしゅうする", romaji: "renshuusuru",  english: "To practice",                      category: "actions" },
  { word: "掃除する",     hiragana: "そうじする",     romaji: "soujisuru",    english: "To clean / sweep",                 category: "actions" },
  { word: "洗濯する",     hiragana: "せんたくする",   romaji: "sentakusuru",  english: "To do laundry",                    category: "actions" },
  { word: "散歩する",     hiragana: "さんぽする",     romaji: "sanposuru",    english: "To go for a walk",                 category: "actions" },
  { word: "運転する",     hiragana: "うんてんする",   romaji: "untensuru",    english: "To drive",                         category: "actions" },
  { word: "注文する",     hiragana: "ちゅうもんする", romaji: "chuumonsuru",  english: "To order (food)",                  category: "actions" },
  { word: "料理する",     hiragana: "りょうりする",   romaji: "ryourisuru",   english: "To cook",                          category: "actions" },
  { word: "運動する",     hiragana: "うんどうする",   romaji: "undousuru",    english: "To exercise",                      category: "actions" },
  { word: "履く",         hiragana: "はく",           romaji: "haku",         english: "To wear (shoes / lower body)",     category: "actions" },
  { word: "かぶる",       hiragana: "かぶる",         romaji: "kaburu",       english: "To put on (hat)",                  category: "actions" },
  { word: "磨く",         hiragana: "みがく",         romaji: "migaku",       english: "To brush / polish",                category: "actions" },
  { word: "拾う",         hiragana: "ひろう",         romaji: "hirou",        english: "To pick up",                       category: "actions" },
  { word: "焼く",         hiragana: "やく",           romaji: "yaku",         english: "To grill / bake",                  category: "actions" },
  { word: "浴びる",       hiragana: "あびる",         romaji: "abiru",        english: "To shower / bathe",                category: "actions" },
  { word: "晴れる",       hiragana: "はれる",         romaji: "hareru",       english: "To clear up (weather)",            category: "actions" },
  { word: "吹く",         hiragana: "ふく",           romaji: "fuku",         english: "To blow (wind)",                   category: "actions" },
  { word: "増える",       hiragana: "ふえる",         romaji: "fueru",        english: "To increase (intransitive)",       category: "actions" },
  { word: "減る",         hiragana: "へる",           romaji: "heru",         english: "To decrease / diminish",           category: "actions" },
  { word: "習う",         hiragana: "ならう",         romaji: "narau",        english: "To learn / take lessons",          category: "actions" },
  { word: "始まる",       hiragana: "はじまる",       romaji: "hajimaru",     english: "To begin / start (intransitive)",  category: "actions" },
  { word: "渡す",         hiragana: "わたす",         romaji: "watasu",       english: "To hand over / pass",              category: "actions" },
  { word: "喋る",         hiragana: "しゃべる",       romaji: "shaberu",      english: "To chat / talk",                   category: "actions" },
  { word: "集める",       hiragana: "あつめる",       romaji: "atsumeru",     english: "To collect / gather",              category: "actions" },
  { word: "感じる",       hiragana: "かんじる",       romaji: "kanjiru",      english: "To feel / sense",                  category: "actions" },
  { word: "混む",         hiragana: "こむ",           romaji: "komu",         english: "To get crowded",                   category: "actions" },
  { word: "空く",         hiragana: "あく",           romaji: "aku",          english: "To become empty / available",      category: "actions" },
  { word: "足りる",       hiragana: "たりる",         romaji: "tariru",       english: "To be sufficient / enough",        category: "actions" },
  { word: "受ける",       hiragana: "うける",         romaji: "ukeru",        english: "To take (a test) / receive",       category: "actions" },
  { word: "貼る",         hiragana: "はる",           romaji: "haru",         english: "To paste / stick",                 category: "actions" },

  // ── New Adjectives (20) ───────────────────────────────────────────────────
  { word: "寂しい",       hiragana: "さびしい",       romaji: "sabishii",     english: "Lonely",                           category: "adjectives" },
  { word: "恥ずかしい",   hiragana: "はずかしい",     romaji: "hazukashii",   english: "Embarrassing / Ashamed",           category: "adjectives" },
  { word: "うるさい",     hiragana: "うるさい",       romaji: "urusai",       english: "Noisy / Loud",                     category: "adjectives" },
  { word: "若い",         hiragana: "わかい",         romaji: "wakai",        english: "Young",                            category: "adjectives" },
  { word: "欲しい",       hiragana: "ほしい",         romaji: "hoshii",       english: "Wanted / Desirable",               category: "adjectives" },
  { word: "辛い",         hiragana: "つらい",         romaji: "tsurai",       english: "Tough / Painful (emotionally)",    category: "adjectives" },
  { word: "深い",         hiragana: "ふかい",         romaji: "fukai",        english: "Deep",                             category: "adjectives" },
  { word: "浅い",         hiragana: "あさい",         romaji: "asai",         english: "Shallow",                          category: "adjectives" },
  { word: "低い",         hiragana: "ひくい",         romaji: "hikui",        english: "Low",                              category: "adjectives" },
  { word: "濃い",         hiragana: "こい",           romaji: "koi",          english: "Thick / Strong (flavor or color)", category: "adjectives" },
  { word: "暇",           hiragana: "ひま",           romaji: "hima",         english: "Free / Not busy",                  category: "adjectives" },
  { word: "苦手",         hiragana: "にがて",         romaji: "nigate",       english: "Weak at / Uncomfortable with",     category: "adjectives" },
  { word: "立派",         hiragana: "りっぱ",         romaji: "rippa",        english: "Splendid / Impressive",            category: "adjectives" },
  { word: "不安",         hiragana: "ふあん",         romaji: "fuan",         english: "Uneasy / Anxious",                 category: "adjectives" },
  { word: "嫌",           hiragana: "いや",           romaji: "iya",          english: "Unpleasant / Disagreeable",        category: "adjectives" },
  { word: "ひどい",       hiragana: "ひどい",         romaji: "hidoi",        english: "Terrible / Awful",                 category: "adjectives" },
  { word: "素晴らしい",   hiragana: "すばらしい",     romaji: "subarashii",   english: "Wonderful / Splendid",             category: "adjectives" },
  { word: "可哀想",       hiragana: "かわいそう",     romaji: "kawaisou",     english: "Poor thing / Pitiful",             category: "adjectives" },
  { word: "きつい",       hiragana: "きつい",         romaji: "kitsui",       english: "Tight / Strict / Harsh",           category: "adjectives" },
  { word: "温かい",       hiragana: "あたたかい",     romaji: "atatakai",     english: "Warm (food / feeling)",            category: "adjectives" },

  // ── New Objects (20) ──────────────────────────────────────────────────────
  { word: "ノート",       hiragana: "のーと",         romaji: "nooto",        english: "Notebook",                         category: "objects" },
  ...
  { word: "毛布",         hiragana: "もうふ",         romaji: "moufu",        english: "Blanket",                          category: "objects" },
  { word: "歯ブラシ",     hiragana: "はぶらし",       romaji: "haburashi",    english: "Toothbrush",                       category: "objects" },
  { word: "スリッパ",     hiragana: "すりっぱ",       romaji: "surippa",      english: "Slippers",                         category: "objects" },
  { word: "上着",         hiragana: "うわぎ",         romaji: "uwagi",        english: "Jacket / Outerwear",               category: "objects" },
  { word: "花瓶",         hiragana: "かびん",         romaji: "kabin",        english: "Flower vase",                      category: "objects" },
  { word: "印鑑",         hiragana: "いんかん",       romaji: "inkan",        english: "Personal seal / Stamp",            category: "objects" },
  { word: "筆",           hiragana: "ふで",           romaji: "fude",         english: "Writing brush",                    category: "objects" },
  { word: "マフラー",     hiragana: "まふらー",       romaji: "mafuraa",      english: "Scarf",                            category: "objects" },
  { word: "下着",         hiragana: "したぎ",         romaji: "shitagi",      english: "Underclothes / Underwear",         category: "objects" },
  { word: "ランドセル",   hiragana: "らんどせる",     romaji: "randoseru",    english: "School backpack",                  category: "objects" },
  { word: "お茶碗",       hiragana: "おちゃわん",     romaji: "ochawan",      english: "Rice bowl",                        category: "objects" },
  { word: "バケツ",       hiragana: "ばけつ",         romaji: "baketsu",      english: "Bucket",                           category: "objects" },

  // ── New Places (15) ───────────────────────────────────────────────────────
  { word: "地下鉄",       hiragana: "ちかてつ",       romaji: "chikatetsu",   english: "Subway / Underground rail",        category: "places" },
  { word: "バス停",       hiragana: "ばすてい",       romaji: "basutei",      english: "Bus stop",                         category: "places" },
  { word: "動物園",       hiragana: "どうぶつえん",   romaji: "doubutsuen",   english: "Zoo",                              category: "places" },
  { word: "遊園地",       hiragana: "ゆうえんち",     romaji: "yuuenchi",     english: "Amusement park",                   category: "places" },
  { word: "美術館",       hiragana: "びじゅつかん",   romaji: "bijutsukan",   english: "Art museum",                       category: "places" },
  { word: "博物館",       hiragana: "はくぶつかん",   romaji: "hakubutsukan", english: "Museum",                           category: "places" },
  { word: "本屋",         hiragana: "ほんや",         romaji: "honya",        english: "Bookstore",                        category: "places" },
  { word: "薬局",         hiragana: "やっきょく",     romaji: "yakkyoku",     english: "Pharmacy",                         category: "places" },
  { word: "大学",         hiragana: "だいがく",       romaji: "daigaku",      english: "University",                       category: "places" },
  { word: "小学校",       hiragana: "しょうがっこう", romaji: "shougakkou",   english: "Elementary school",                category: "places" },
  { word: "中学校",       hiragana: "ちゅうがっこう", romaji: "chuugakkou",   english: "Middle school / Junior high",      category: "places" },
  { word: "高校",         hiragana: "こうこう",       romaji: "koukou",       english: "High school",                      category: "places" },
  { word: "パン屋",       hiragana: "ぱんや",         romaji: "panya",        english: "Bakery",                           category: "places" },
  { word: "水族館",       hiragana: "すいぞくかん",   romaji: "suizokukan",   english: "Aquarium",                         category: "places" },
  { word: "花屋",         hiragana: "はなや",         romaji: "hanaya",       english: "Flower shop",                      category: "places" },

  // ── New Food (15) ─────────────────────────────────────────────────────────
  { word: "刺身",         hiragana: "さしみ",         romaji: "sashimi",      english: "Sashimi (raw fish slices)",        category: "food" },
  { word: "餃子",         hiragana: "ぎょうざ",       romaji: "gyouza",       english: "Gyoza / Dumplings",                category: "food" },
  { word: "焼き鳥",       hiragana: "やきとり",       romaji: "yakitori",     english: "Grilled chicken skewers",          category: "food" },
  { word: "焼きそば",     hiragana: "やきそば",       romaji: "yakisoba",     english: "Fried noodles",                    category: "food" },
  { word: "漬物",         hiragana: "つけもの",       romaji: "tsukemono",    english: "Pickled vegetables",               category: "food" },
  { word: "味噌",         hiragana: "みそ",           romaji: "miso",         english: "Miso (fermented soybean paste)",   category: "food" },
  { word: "油",           hiragana: "あぶら",         romaji: "abura",        english: "Oil",                              category: "food" },
  { word: "酢",           hiragana: "す",             romaji: "su",           english: "Vinegar",                          category: "food" },
  { word: "お米",         hiragana: "おこめ",         romaji: "okome",        english: "Uncooked rice",                    category: "food" },
  { word: "お湯",         hiragana: "おゆ",           romaji: "oyu",          english: "Hot water",                        category: "food" },
  { word: "サラダ",       hiragana: "さらだ",         romaji: "sarada",       english: "Salad",                            category: "food" },
  { word: "サンドイッチ", hiragana: "さんどいっち",   romaji: "sandoicchi",   english: "Sandwich",                         category: "food" },
  { word: "チョコレート", hiragana: "ちょこれーと",   romaji: "chokoreeto",   english: "Chocolate",                        category: "food" },
  { word: "マヨネーズ",   hiragana: "まよねーず",     romaji: "mayoneezu",    english: "Mayonnaise",                       category: "food" },
  { word: "胡椒",         hiragana: "こしょう",       romaji: "koshou",       english: "Black pepper",                     category: "food" },
];
