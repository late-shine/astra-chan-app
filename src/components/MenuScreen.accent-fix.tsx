...
export default function MenuScreen(props: MenuScreenProps) {
  ...
  return (
            ...
            >
              {showStudyRoom ? (
                <div className="relative overflow-hidden rounded-3xl glass-card-elevated p-5 sm:p-7">
                  ...
                  <div className="relative z-10 flex flex-col gap-6">
                    <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-5 items-stretch">
                      <div className="flex flex-col justify-between gap-5 min-h-[270px] rounded-2xl glass-card p-5">
                        <div>
                      ...
                      <div className="relative min-h-[270px] rounded-2xl glass-card glass-glow overflow-hidden p-5 flex items-center justify-center">
                      ...
                      {[
                        ...
                        return (
                          <TiltCard
                            ...
                            tiltMax={12}
                            scale={1.03}
                            className={`group min-h-28 rounded-2xl glass-card glass-glow p-4 text-left cursor-pointer ${accentHoverBorder} ${accentTextColor}`}
                          >
                            <div className="flex items-start justify-between gap-3">
                              ...
                              <span className="rounded-xl border border-natural-border/70 bg-natural-bg/70 p-2 text-current backdrop-blur-sm">
